...
#%%
# TiSASRec version of the flexible, signed K-component multiscale Hawkes
# prior (module.debias_multiscale): only the excitation term changes, mu_v's
# own parameterization is unchanged, so -- as with the other Hawkes
# variants -- there is no --ablation branching.
