...
#%%
# Pre-compute item popularity from all training events
pop_scores = build_item_popularity(dataset.train_events, dataset.m_item)
...
pattern = f"tide_lambda{args.lambda1}_lr{args.lr}_alpha{args.alpha}_e???_seed{args.seed}.pt"
