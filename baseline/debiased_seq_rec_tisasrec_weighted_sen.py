...
if wandb_login:
    ...
    wandb_var = wandb.init(project="ldr_rec_sen", config=vars(args))
...
pattern = f"_{args.model_name}_lambda{args.lambda1}_e???_seed{args.seed}_ablation{args.ablation}_tau{args.tau}.pt"
...
while epoch < args.epochs: 
    ...
    if epoch % 100 == 0:
        ...
        }, f"{args.save_path}/_{args.model_name}_lambda{args.lambda1}_e{epoch}_seed{args.seed}_ablation{args.ablation}_tau{args.tau}.pt")
