...
#%%
# This script only replaces the single-timescale Hawkes excitation with a
# two-timescale one (mu_v is unchanged), so -- as with
# debiased_seq_rec_hawkes_timevarying.py -- there is no --ablation branching:
# build_two_timescale_debias_model is the single wrapper used.
