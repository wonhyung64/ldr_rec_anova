...
declare -A ALPHA1_FOR=(
    [micro_video,mf]=0.3      [micro_video,grurec]=   [micro_video,sasrec]=0.1
    [micro_video,tisasrec]= [micro_video,fearec]=0.1  [micro_video,bsarec]=0.1
    [ml-1m,mf]=0.7             [ml-1m,grurec]=0.5        [ml-1m,sasrec]=0.5
    [ml-1m,tisasrec]=0.5       [ml-1m,fearec]=0.3        [ml-1m,bsarec]=0.5
    [kuairand,mf]=          [kuairand,grurec]=     [kuairand,sasrec]=
    [kuairand,tisasrec]=    [kuairand,fearec]=     [kuairand,bsarec]=
)
